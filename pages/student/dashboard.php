...
<body>
    ...
    <div class="container">
        <div class="welcome">
            ...
            <p>Jelajahi berbagai ekstrakurikuler yang tersedia di sekolah kami.</p>
        </div>
        ...
        <div class="filters">
            ...
            <div class="category-filter">
                ...
                <button class="filter-btn" data-category="seni">Seni</button>
                <button class="filter-btn" data-category="olahraga">Olahraga</button>
                <button class="filter-btn" data-category="bahasa">Bahasa</button>
                <button class="filter-btn" data-category="sains">Sains & Teknologi</button>
            </div>
        </div>
     ...
     <script>
        ...
        function filterCards(category, searchTerm) {
            ...
            cards.forEach(card => {
                ...
                const cardName = card.querySelector('.extracurricular-name').textContent.toLowerCase();
            ...
            if (noResults) {
                ...
                const grid = document.getElementById('extracurricularsGrid');
                const noResultsDiv = document.createElement('div');
                noResultsDiv.className = 'no-results';
                noResultsDiv.textContent = 'Tidak ada ekstrakurikuler yang ditemukan.';
